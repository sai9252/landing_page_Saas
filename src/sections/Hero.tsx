        ...
        <div className="md:flex items-center">
          <div className="md:w-[478px]">
            ...
            <p className="text-xl text-[#01003E] tracking-tight mt-6">
              celebrate to the joy of accomplishment with an app design to track your progress, motivate your efforts, and celebrate your successes.
            </p>
          ...
          <div className="mt-20 md:mt-0 md:h-[648px] md:flex-1 relative">
            ...
            />
            <motion.img src={Cylinder.src} alt="Cylinder image" width={220} height={220} className=" hidden md:block -top-8 -left-32 md:absolute"
            style={{
              translateY: translateY,
            }}
            />
            <motion.img src={NoodleImage.src} alt="Noodel image" width={220} className="hidden lg:block absolute top-[524px] left-[440px] rotate-[30deg] "
            style={{
              rotate: 30,
              translateY: translateY,
            }}
