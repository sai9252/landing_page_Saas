  ...
  return (<section className="bg-gradient-to-b from-[#FFFFFF] to-[#D2DCFF] py-24 overflow-x-clip">
    <div className="container">
      <div className="section-heading ">
        ...
        <h2 className="section-title">A more effective way to track process</h2>
      ...
      <div className="relative">
        ...
        <motion.img src={tubeImage.src} alt="Tube Image" className=" hidden md:block absolute bottom-24 -left-36" height={248} width={248} style={{
          translateY: translateY,
        }} />
      </div>
    </div>
